                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td width="200px">
                                        <a href="./changeCost.php?id=<?php echo $rows['ID'] ?>"><img style="width: 35px;" src="../../public/img/changee.avif"></a>
                                        <a href="./DeleteCost.php?id=<?php echo $rows['ID'] ?>" onclick="return checkDelete()"><img style="width: 35px;" src="../../public/img/deletee.jpg"></a>
                                    </td>
                                </tr>
                        <?php
                            }
