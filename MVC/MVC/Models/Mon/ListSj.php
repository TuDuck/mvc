                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td width="200px">
                                        <a href="./Suamon.php?mamon=<?php echo $rows['Mamh'] ?>"><img style="width: 35px;" src="../../public/img/changee.avif"></a>
                                        <a href="./Xoamon.php?mamon=<?php echo $rows['Mamh'] ?>" onclick="return checkDelete()"><img style="width: 35px;" src="../../public/img/deletee.jpg"></a>
                                    </td>
                                </tr>
                        <?php
                            }
