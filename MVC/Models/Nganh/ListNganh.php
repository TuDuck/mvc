...
if (isset($_POST['btnTimkiem'])) {
    ...
    $sqlTim = "SELECT Manganh, Tennganh, hoc_ky.Tenhk FROM nganh_hoc, hoc_ky WHERE nganh_hoc.Mahk = hoc_ky.Mahk, Manganh like '%$Manganh%' and Tennganh like '%$Tennganh%' and hoc_ky.Mahk like '%$tenhk%'";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td width="200px" align="center">
                                        <a href="./Suanganh.php?manganh=<?php echo $rows['Manganh'] ?>"><img style="width: 35px;" src="../image/changee.avif"></a>
                                        <a href="./Xoanganh.php?manganh=<?php echo $rows['Manganh'] ?>" onclick="return checkDelete()"><img style="width: 35px;" src="../image/deletee.jpg"></a>
                                    </td>
                                </tr>
                        <?php
                            }
